...
function iv_addError($severity, $message, $filepath, $line, $defaultError = true)
{
	ivErrors::add($severity, $message, $filepath, $line, $defaultError);
}

set_error_handler('iv_addError');
