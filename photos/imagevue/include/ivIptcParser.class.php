...
class ivIptcParser
{
	...
	function _getFileFormat($format)
	{
		$formats = array(
			'00' => 'No ObjectData',
	...
	function _getActionAdvised($action)
	{
		$actions = array(
			'01' => 'Object Kill',
			'02' => 'Object Replace',
	...
	function _getObjectCycle($cycle)
	{
		$cycles = array(
			'a' => 'Morning',
	...
	function _getEditorialUpdate($update)
	{
		$updates = array(
	...
	function _getImageOrientation($orientation)
	{
		$orientations = array(
			'L' => 'Landscape',
			'P' => 'Portrait',
